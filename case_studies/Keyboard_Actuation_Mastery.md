# ⌨️ Case Study: Keyboard Actuation Point Mastery
### *Domain: Physical Object — Haptic Feedback Optimization*
...
*   **Evaluation**:
    *   **Predicted**: Light touch to actuation point.
    *   **Actual**: Key triggers but excess force slams the keycap into the plate.
    *   **Delta**: Quán tính ngón tay vượt quá điểm nhận lệnh 2mm trong thời gian cực ngắn.
*   **Test performed**: Typing a short code snippet using only the index finger, attempting to stop the motion immediately as the character appears on screen.
*   **Test result**: Speed dropped to 10 WPM. When speed increased, bottom-out returned immediately.
*   **Measured signals**: 75dB "clack" sound; recoil vibration felt in fingertips; extensor muscles in forearm are tense.
*   **Failure type**: Perception Error (Misjudgment of the stop point).
